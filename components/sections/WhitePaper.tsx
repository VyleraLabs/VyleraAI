            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="space-y-12">
                    ...
                    <div className="prose prose-invert prose-sm">
                        ...
                        <ul className="list-none space-y-2 p-0 text-slate font-light">
                    ...
                    <div className="pt-4">
                        ...
                        >
                            ...
                            <span className="text-xs text-slate/40 group-hover:text-cyan/40 ml-2 relative z-10">(Technical Abstract)</span>
                        </button>
                    </div>
                ...
                <div className="relative mt-8 lg:mt-0">
                    ...
                    <div className="relative bg-[#050f1e] rounded border border-white/10 p-1 font-mono text-xs shadow-2xl">
                        ...
                        <div className="bg-[#0a192f] border-b border-white/5 p-3 flex items-center justify-between">
                            ...
                            <div className="text-slate/40 flex items-center gap-2">
                            ...
                            >
                                {[...logs, ...logs, ...logs].map((log, i) => (
                                    <div key={i} className="flex gap-3 text-slate/70 font-light">
                                        <span className="text-slate/30 select-none w-6 text-right">{(i + 1).toString().padStart(2, '0')}</span>
                                        <span className={
