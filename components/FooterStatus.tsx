...
export default function FooterStatus() {
    ...
    return (
        <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 h-10 bg-black/40 backdrop-blur-md border-t border-slate-800 z-50 flex items-center justify-between px-4 md:px-6 text-[10px] md:text-xs font-mono text-slate/60 uppercase tracking-wider pointer-events-none"
        >
            {/* Left: Version */}
            ...
            <div className="flex items-center gap-4">
                <a href="/about" className="text-slate/60 hover:text-green-400 transition-colors hidden md:block pointer-events-auto">ABOUT</a>
